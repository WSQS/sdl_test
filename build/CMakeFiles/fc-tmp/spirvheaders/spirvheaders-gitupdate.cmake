...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "vulkan-sdk-1.4.328.1"
  WORKING_DIRECTORY "/home/runner/work/sdl_test/sdl_test/build/_deps/spirvheaders-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/runner/work/sdl_test/sdl_test/build/_deps/spirvheaders-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/runner/work/sdl_test/sdl_test/build/_deps/spirvheaders-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
